...
enum class TaskStatus {
    ACTIVE,     // Активно — принимает отклики, виден в студенческом фиде
    CLOSED,     // В работе — исполнитель выбран, скрыт из фида
    COMPLETED,  // Завершено — оба подтвердили выполнение
    DRAFT       // Черновик
}
